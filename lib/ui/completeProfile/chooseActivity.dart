...
//                           imageUrl: Constant.getCategory!.data![index].categoryIcon.toString(), height: 32,),
//                       ),
//                       title: Text(Constant.getCategory!.data![index].categoryName.toString(), style: CustomTextStyles.semiBold(fontSize: 21),),
//                     ),
//                   ),
//                 ),
//               );
...
class _ChooseActivityState extends State<ChooseActivity> {
  List<String> selectedActivities = []; // multiple select list
