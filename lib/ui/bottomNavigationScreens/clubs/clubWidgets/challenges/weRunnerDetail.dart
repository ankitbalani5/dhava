...
class WeRunnerDetail extends StatefulWidget {
  const WeRunnerDetail({super.key});

  @override
  State<WeRunnerDetail> createState() => _WeRunnerDetailState();
}

class _WeRunnerDetailState extends State<WeRunnerDetail> {
  @override
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text('Join', style: CustomTextStyles.medium(fontSize: 11, textColor: Colors.white),),
                  ),
                )
                // Row(
                //   children: [
