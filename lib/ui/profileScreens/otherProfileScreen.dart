      ...
      body: BlocConsumer<OtherProfileBloc, OtherProfileState>(
        ...
        builder:(context, state){
          ...
          if (state is OtherProfileSuccess){
            ...
            var photoUrl=profileData?.profilePhoto;
            ...
            var country  = profileData?.country;
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text('${firstName ?? 'User'} ${lastName?? ''}', style: CustomTextStyles.bold(fontSize: 26 ),),
                        Row(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Column(
                            children: [
                              Text(totalFollowers.toString(), style: CustomTextStyles.bold(fontSize: 14, textColor: Colors.black),),
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            children: [
                              Text(totalFollowing.toString(), style: CustomTextStyles.bold(fontSize: 14, textColor: Colors.black),),
