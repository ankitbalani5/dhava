...
class NotificationModelData {
  ...
  NotificationModelData.fromJson(Map<String, dynamic> json) {
    ...
    userProfile = json['user_profile'] != null
        ? new UserProfile.fromJson(json['user_profile'])
        : null;
    followsId = json['follows_id'];
    notificaionType = json['notificaion_type'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['follows_id'] = this.followsId;
    data['notificaion_type'] = this.notificaionType;
    return data;
  }
}
