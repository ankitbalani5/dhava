class ActiveChallengeModel {
  ...
  ActiveChallengeModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new ActiveChallengeData.fromJson(v));
      });
    }
...
class ActiveChallengeData {
  ...
  ActiveChallengeData.fromJson(Map<String, dynamic> json) {
