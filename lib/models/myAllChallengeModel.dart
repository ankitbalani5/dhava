class MyAllChallengeModel {
  ...
  MyAllChallengeModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new MyAllChallengeData.fromJson(v));
      });
    }
...
class MyAllChallengeData {
  ...
  MyAllChallengeData.fromJson(Map<String, dynamic> json) {
