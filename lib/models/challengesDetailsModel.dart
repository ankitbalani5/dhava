class ChallengesDetailModel {
  ...
  ChallengesDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['following_users'] != null) {
      followingUsers = List<dynamic>.from(json['following_users']).cast<Null>();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (followingUsers != null) {
      data['following_users'] = followingUsers;
    }
    return data;
  }
}
