class MyJoinedAllChallengesModel {
  bool? status;
  int? statusCode;
  String? message;
  String? errorMessage;
  ...
  MyJoinedAllChallengesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    statusCode = json['status_code'];
    message = json['message'];
    errorMessage = json['error_message'];
    data = json['data'] != null ? new MyJoinedData.fromJson(json['data']) : null;
  }
...
class MyJoinedData {
  ...
  MyJoinedData.fromJson(Map<String, dynamic> json) {
    page = json['page'];
